    ...
    <div class="setting-block level">
        ...
        <div class="level-select">
            <label for="level-select-single" :class="['level-select-label', { active: !store.lvMultiple }]">
                <input :checked="!store.lvMultiple" @click="store.lvMultiple = false" id="level-select-single"
                    type="radio" name="level-select" value="false" />
                <span class="inner">单一难度</span>
            </label>
            <label for="level-select-multiple" :class="['level-select-label', { active: store.lvMultiple }]">
                <input :checked="store.lvMultiple" @click="store.lvMultiple = true" id="level-select-multiple"
                    type="radio" name="level-select" value="true" />
            ...
            <div class="level-number single">
                ...
                <div class="level-number-block radio min">
                    <label class="level-radio-label" for="level-number-plus-no">
                        <input :checked="!store.lvMinPlus" @click="store.lvMinPlus = false" type="radio"
                            name="level-number-plus" id="level-number-plus-no" value="false" />
                        <span class="inner">不带 + 号</span>
                    </label>
                    <label class="level-radio-label" for="level-number-plus-yes">
                        <input :checked="store.lvMinPlus" @click="store.lvMinPlus = true" type="radio"
                            name="level-number-plus" id="level-number-plus-yes" value="true" />
            ...
            <div class="level-number lv-min">
                ...
                <div class="level-number-block radio min">
                    <label class="level-radio-label" for="level-min-plus-no">
                        <input :checked="!store.lvMinPlus" @click="store.lvMinPlus = false" type="radio"
                            name="level-min-plus" id="level-min-plus-no" value="false" />
                        <span class="inner">不带 + 号</span>
                    </label>
                    <label class="level-radio-label" for="level-min-plus-yes">
                        <input :checked="store.lvMinPlus" @click="store.lvMinPlus = true" type="radio"
                            name="level-min-plus" id="level-min-plus-yes" value="true" />
                        <span class="inner">带 + 号</span>
                    </label>
                </div>
                ...
                <div class="level-number-block radio max">
                    <label class="level-radio-label" for="level-max-plus-no">
                        <input :checked="!store.lvMaxPlus" @click="store.lvMaxPlus = false" type="radio"
                            name="level-max-plus" id="level-max-plus-no" value="false" />
                        <span class="inner">不带 + 号</span>
                    </label>
                    <label class="level-radio-label" for="level-max-plus-yes">
                        <input :checked="store.lvMaxPlus" @click="store.lvMaxPlus = true" type="radio"
                            name="level-max-plus" id="level-max-plus-yes" value="true" />
                        <span class="inner">带 + 号</span>
                    </label>
                </div>
            </div>
    ...
    .level-number-block {
        ...
        &.min {
            input[type="number"] {
                ...
                &:focus {
                    box-shadow: 0 0 3px var(--color-A);
                }
            }
        ...
        &.max {
            input[type="number"] {
                ...
                &:focus {
                    box-shadow: 0 0 3px var(--color-M);
                }
            }
